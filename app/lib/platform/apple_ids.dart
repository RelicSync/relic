...
/// targets, and the Share Extension can never drift
...
/// Share Extension bundle identifier (the `RelicShare` target in
/// ios/Runner.xcodeproj, embedded as RelicShare.appex).
